        ...
        >
            {
                form === 'login'
                    ?
                    <LoginForm change={(e) => setForm('register')} hide={(e) => setVisible(false)} verifySessionToken={verifySessionToken} />
                    :
                    <RegisterForm change={(e) => setForm('login')} hide={(e) => setVisible(false)} />
            }
        </Dialog>
    );
}
